    ...
    >
      <HabitWrapper>
        <Intro>
          ...
          of wellness and see how you can integrate these habits into your daily
          life to build health and resilience.
        </Intro>
        <Habit1>
          <Title>Habit 1: Sleep</Title>
          Most teens/adults need between 7-9 hours of sleep each night. Remember
          you can’t “catch up” on sleep by pulling all-nighters and then
          sleeping in on the weekend. Healthy sleep habits mean a regular sleep
          routine, going to bed at the same time each night, and waking up at
          the same time each morning. Limit the use of screen-time in the hour
          before sleep and have a relaxing ritual (music, reading, praying)
        ...
        <Habit2>
          ...
          household chores, skiing, skating, etc. Being outdoors while
        ...
        <Habit3>
          ...
          highly processed foods. Sometimes our splurges over the holiday season
        ...
        <Habit4>
          ...
          meaningful activities we can become bored or depressed. Learn what is
          a good amount of activity for your personality and lifestyle and
          practice that balance.
        </Habit4>
        <Habit5>
          <Title>Habit 5: Social Connections</Title>
          This is at the end of the list, however, it is one of the most
          important habits of wellness. If we have strong connections to family
          and friends, we feel better and even live longer. To have someone to
          talk to, spend time with, and share a laugh or cry together will make
